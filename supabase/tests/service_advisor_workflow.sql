...
('16000000-0000-4000-8000-000000000005','00000000-0000-0000-0000-000000000000','authenticated','authenticated','advisor-technician@example.com','',now(),'{}','{}',now(),now());
...
('26000000-0000-4000-8000-000000000001','16000000-0000-4000-8000-000000000005','technician');
...
('96000000-0000-4000-8000-000000000001','26000000-0000-4000-8000-000000000001','46000000-0000-4000-8000-000000000001','56000000-0000-4000-8000-000000000001','66000000-0000-4000-8000-000000000001',1,'queued','16000000-0000-4000-8000-000000000005'),
('96000000-0000-4000-8000-000000000002','26000000-0000-4000-8000-000000000002','46000000-0000-4000-8000-000000000003','56000000-0000-4000-8000-000000000002','66000000-0000-4000-8000-000000000002',1,'queued',null);
...
select throws_ok($$select start_automotive_job_work_session('96000000-0000-4000-8000-000000000001','16000000-0000-4000-8000-000000000005')$$,'P0001','Reserve all required parts before work starts','unreserved parts block canonical work start');
...
select lives_ok($$select start_automotive_job_work_session('96000000-0000-4000-8000-000000000001','16000000-0000-4000-8000-000000000005')$$,'approved work with ready parts starts through work tracking');
select lives_ok($$select end_automotive_job_work_session((select id from automotive_job_order_work_sessions where job_order_id='96000000-0000-4000-8000-000000000001'),'stop','Ready for QC')$$,'technician session stops before QC');
