...
('25000000-0000-4000-8000-000000000001','15000000-0000-4000-8000-000000000005','cashier');
...
select throws_ok($$select convert_queue_to_job((select id from queue_entries))$$,'P0001','Queue entry cannot start a job','queue cannot convert twice');
...
select lives_ok($$insert into job_inspections(organization_id,job_order_id,exterior_notes,inspected_by) values('25000000-0000-4000-8000-000000000001',(select id from job_orders where organization_id='25000000-0000-4000-8000-000000000001'),'ok','15000000-0000-4000-8000-000000000003')$$,'assigned technician records inspection');
