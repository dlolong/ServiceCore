...
export async function recoverEstimateApprovalLinkAction(_previous:RecoverApprovalLinkActionState,data:FormData):Promise<RecoverApprovalLinkActionState>{
  ...
  }catch(error){return{error:error instanceof Error?error.message:"The active approval link could not be displayed."};}
}
...
export async function reserveAdvisorJobPart(data:FormData) {
  ...
  catch(error){go(jobId,"error",error instanceof Error?error.message:"Unable to reserve this part.");}
...
export async function reserveAdvisorRequiredJobParts(data:FormData) {
  ...
  catch(error){go(jobId,"error",error instanceof Error?error.message:"Unable to reserve the required parts.");}
...
export async function consumeAdvisorJobPart(data:FormData) {
  ...
  catch(error){go(jobId,"error",error instanceof Error?error.message:"Unable to record part usage.");}
...
export async function releaseAdvisorJobPart(data:FormData) {
  ...
  catch(error){go(jobId,"error",error instanceof Error?error.message:"Unable to release this reservation.");}
