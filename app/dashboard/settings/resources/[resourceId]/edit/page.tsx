...
export default async function EditSchedulingResourcePage({ params }: { params: Promise<{ resourceId: string }> }) {
  ...
  return <div id="scheduling-resource-edit-page" className="mx-auto max-w-3xl"><p className="text-sm font-bold text-brand-primary">Settings</p><h1 className="mt-1 text-3xl font-black">Edit service bay</h1><div className="mt-6">{form}</div></div>;
}
